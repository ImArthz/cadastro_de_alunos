...
class Gerenciadora:
    ...
    def Criar_aluno(alunos):
        try:
            ...
            while True:
                temp_aluno_matricula = "2023" + str(random.randint(1, 9)) + str(random.randint(1, 9)) + str(random.randint(1, 9)) + str(random.randint(1, 9)) + str(random.randint(1, 9)) + str(random.randint(1, 9)) + str(random.randint(1, 9)) + str(random.randint(1, 9))
    ...
    def Consultar_aluno(matricula):
        try:
            ...
            for aluno in alunos:
                ...
                if not encontrado:
                    print("Não existe nenhum aluno com este numero de matricula ")
                    while True:
                        escolha = input("Deseja visualizar os alunos matriculados?\n\tSim\n\tNão: ").lower()
                        Gerenciadora.Listar_alunos() if escolha in ('sim', 's') else (print("Voltando ao menu...") if escolha in ('não', 'n') else print("Escolha inválida."))
    ...
    def Menu():
        while True:
            ...
            try:
                ...
                print("Opção inválida. Por favor, digite um número de opção válido (1, 2, 3 ou 4).")
            ...
            case 4:
                while True:
                    ...
                    if aux in ('nao', 'n', 'não'):
                        ...
                        escolha_aux = input(f"você está prestes a excluir o aluno de matricula {temp_matricula2} tem certeza ? (S/N)").lower()
